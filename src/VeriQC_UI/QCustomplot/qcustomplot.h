...
public:
  ...
  */
  ...
  void setTickerIntervalSame(bool intervalSame);
  double getSubTickerStep(const QCPRange& range);
protected:
  // property members:
...
class QCP_LIB_DECL QCPCicleGrid :public QCPLayerable
{
   Q_OBJECT
   /// \cond INCLUDE_QPROPERTIES
   Q_PROPERTY(bool subGridVisible READ subGridVisible WRITE setSubGridVisible)
   ...
   /// \endcond
public:
    explicit QCPCicleGrid(QCPAxis* horizntalAxis, QCPAxis* verticalAxis);
...
protected:
    ...
    // non-virtual methods:
    void drawCicleGridLines(QCPPainter* painter) const;
    void drawCicle(QCPPainter* painter, int zeroLineIndex) const;
    void drawRectLine(QCPPainter* painter) const;
    void drawSubGridLines(QCPPainter* painter) const;

    int findSubZeroLineIndex(double& subt)const;
    void findZeroLineIndex(int zeroLineIndex, double& t)const;
    double getSubStep(const QVector<double>& ticker, const QVector<double>& subTicker)const;
    friend class QCPAxis;
};
...
public:
  ...
  */
  ...
  void setMinZoomInLimite(bool state);
  void setViewCenter(bool center);
  // reimplemented virtual methods:
  virtual double selectTest(const QPointF &pos, bool onlySelectable, QVariant *details=nullptr) const Q_DECL_OVERRIDE;
  ...
  void setFixedAxisLabelWidth(int width, WidthType viewType = WidthType::Normal);
  int getFixedAxisLabelWidth()const;
...
public:
  ...
  virtual void draw2(QCPPainter *painter);
  virtual int size();
  void clearCache();
...
public:
  ...
  */
  ...
  bool centerPlot()const { return mCenterPlot; };
  ...
  void setCenterPlot(bool bCenterPlot);
